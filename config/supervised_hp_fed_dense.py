...
config['log_every'] = 2
config['model_fp'] = 'dense_classifier_fl_{}.h5'
...
hparam_map = {'supervised_mask_ratio': hp.HParam('supervised_mask_ratio', hp.Discrete([0.0, 0.20, 0.40, 0.60, 0.80, 0.90, 0.95, 0.975, 0.99, 1.00])),
                ...
                'num_clients_per_round': hp.HParam('num_clients_per_round', hp.Discrete([100])),
                'num_epochs': hp.HParam('num_epochs', hp.Discrete([10]))
}
