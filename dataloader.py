...
def mask_examples(client_data, mask_ratio, mask_type, shuffle_buffer=500, seed=None):
    '''
...
def mask_clients(client_data, mask_ratio, mask_type, shuffle_buffer=500, seed=None):
    '''
