...
config['model_fn'] = 'ConvSupervisedModel'
...
config['pretrained_model_fp'] = 'logs/conv_AE/run_0/autoencoder.h5' # FILE PATH SHOULD LOOK SOMETHING LIKE THIS ONCE YOU'VE TRAINED IT
