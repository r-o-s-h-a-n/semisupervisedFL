...
config['log_every'] = 5
config['model_fp'] = 'rotation_emnist_central_supervised.h5'
...
config['pretrained_model_fp'] = 'logs/rotation_emnist_central_unsup/run_0/rotation_emnist_central_unsup.h5'
